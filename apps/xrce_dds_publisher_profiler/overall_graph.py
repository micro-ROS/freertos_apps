...
for i in range(len(names)):
    for j,n in zip(total_usages_steady[i], entities_sizes):
        axs[i].plot(topic_sizes, j, 'o-', markersize=1.5, linewidth=1, label="{:d} pubs".format(n))
...
fig.text(0.5, 1.02, 'Publisher application', ha='center', fontsize=15)
...
plt.savefig("overall_pub" + ".svg", dpi=600, bbox_inches='tight')
plt.savefig("overall_pub" + ".png", dpi=600, bbox_inches='tight')
